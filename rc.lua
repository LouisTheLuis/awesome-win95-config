...
-- Enable Desktop icons (see documentation online for more)
-- Check on the freedesktop folder for modifications
...
-- Inserts a small gap between windows
beautiful.useless_gap = 10
-- Allows gaps to show up even when there is only a single window
beautiful.gap_single_client = true

-- ***** DESKTOP ICONS *****
-- This enables the icons to show on the desktop screen
for s in screen do
