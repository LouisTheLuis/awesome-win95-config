...
theme.ICON_DIR = os.getenv('HOME') .. "/.icons/Chicago95/"

-- theme.font          = "Ubuntu Nerd Font Complete 12" -- TODO: change to better font
theme.font          = "Windows 12" -- TODO: change to better font
-- theme.font_base     = "Ubuntu Nerd Font Complete" -- TODO: change to better font
theme.font_base     = "Windows" -- TODO: change to better font
theme.font_bold     = "Windows Bold" -- TODO: change to better font
...
--[[ Wallpapers ]]
theme.wallpaper            = theme.ICON_DIR .. "wallpaper.png"
theme.lockscreen_wallpaper = theme.ICON_DIR .. "wallpaper.png"
