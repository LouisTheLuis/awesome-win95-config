...
--                                               ___   ___ 
--                                              / _ \ / _ \
--   __ ___      _____  ___  ___  _ __ ___   __| (_) | (_) |
--  / _` \ \ /\ / / _ \/ __|/ _ \| '_ ` _ \ / _ \__, |> _ <
-- | (_| |\ V  V /  __/\__ \ (_) | | | | | |  __/ / /| (_) |
--  \__,_| \_/\_/ \___||___/\___/|_| |_| |_|\___|/_/  \___/
--
--FIX: easy_lauch icons and "separator" widget aren't finished yet!
...
---@param s widget The tasklist widget
---@param c client the client that responds to the widget
...
local widget_box = wibox.widget{
    ...
    widget  = wibox.container.margin,
    {
        ...
        widget = wibox.container.background,
        {
            ...
            widget = wibox.container.margin,
            {
                bg     = beautiful.inactive_color, -- TODO: check if correct
                widget = wibox.container.background,
                {
...
awful.screen.connect_for_each_screen(function (s)
    ...
    local firefox = mywidgets.iconwidget({
        image_path = beautiful.ICON_DIR .."apps/scalable/firefox.svg",
        cmd = function () apps.launch_webbrowser() end,
        hover_text = "firefox",
    })
    local terminal = mywidgets.iconwidget({
        image_path = beautiful.ICON_DIR .. "apps/scalable/utilities-terminal.svg",
        cmd = function () apps.launch_terminal() end,
        hover_text = "terminal",
    })
    local gimp = mywidgets.iconwidget({
        image_path = beautiful.ICON_DIR .. "apps/scalable/gimp.svg",
        cmd = function () apps.launch_gimp() end,
        hover_text = "gimp",
    })
    local thunar = mywidgets.iconwidget({
        image_path = beautiful.ICON_DIR .. "apps/scalable/system-file-manager.svg",
        cmd = function () apps.launch_filemanager_gui() end,
        hover_text = "thunar"
    })
    local easy_launch = {
        layout = wibox.layout.flex.horizontal,
            mywidgets.separator_98(),
            firefox,
            terminal,
            gimp,
            thunar,
